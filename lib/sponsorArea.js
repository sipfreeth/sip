...
export async function updateBookingContent(bookingId, sponsorId, sponsorContentId) {
  // เช็คก่อนว่า booking นี้อนุมัติไปแล้วหรือยัง — ถ้าอนุมัติแล้ว Sponsor แก้เองไม่ได้ ต้องแจ้งทีมงานผ่านแชทแทน
  ...
  if (booking.approval_status === 'approved') {
    throw new Error('เนื้อหานี้ผ่านการอนุมัติแล้ว ไม่สามารถแก้ไขเองได้ กรุณาแจ้งทีมงานผ่านแชทเพื่อขอเปลี่ยนแทน');
  }
