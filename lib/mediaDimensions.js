...
// ---------- ตรวจสอบอัตราส่วนภาพ — อนุโลมให้ "แคบกว่า" 16:9 ได้ (เว้นขอบซ้าย-ขวา ไม่มีอะไรเสียหาย)
// แต่ "กว้างกว่า" 16:9 ไม่ได้ (เสี่ยงโดนตัดขอบบน-ล่างหรือภาพบิดเบี้ยวตอนไปแสดงบนจอจริง) ----------
const TARGET_RATIO = 16 / 9;
const UPPER_TOLERANCE = 0.02; // ผ่อนปรนแค่ฝั่งกว้างกว่าเล็กน้อย (+2%) กันไฟล์จริงที่ปัดเศษพิกเซลนิดหน่อย
...
export function isRatio16x9(width, height) {
  ...
  return ratio <= TARGET_RATIO * (1 + UPPER_TOLERANCE); // แคบกว่าไม่จำกัด (เช่น 4:3, 1:1) กว้างกว่าเกิน 2% ไม่ผ่าน
}
